...
function dropfilter(){
	...
	// getlinks = document.querySelectorAll('.dropdown-contents a');
...
const gettestimonials = document.querySelector('.testimonial');
...
function updatetestimonial(){
	...
	// gettestimonials.textContent = testimonialdatas[idx].text;
	...
	gettestimonials.textContent = text;
